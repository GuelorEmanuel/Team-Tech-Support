 ...
 */
EditStudentProfileControl::EditStudentProfileControl(int profileID, int action) :
 ...
 */
QList<QString> EditStudentProfileControl::loadSection(){
    Questions questions;
 ...
 */
void EditStudentProfileControl::addAsnwers(int ans, int min, int max)
{
    if(count == 28) return;
    if(_action == 1) {
        _answers[count] = ans;
...
int* EditStudentProfileControl::getEditedAnswers()
{
    return _answers;
}

int* EditStudentProfileControl::getEditedMinAnswers() {
    return _maxAnswers;
}

int* EditStudentProfileControl::getEditedMaxAnswers() {
    return _minAnswers;
}

int EditStudentProfileControl::getAnswer(int index)
{
...
int EditStudentProfileControl::getMinAnswer(int index)
{
    if(index < 1 || index > 28) return -1;
...
int EditStudentProfileControl::getMaxAnswer(int index)
{
    if(index < 1 || index > 28) return -1;
...
void EditStudentProfileControl::editQualification(int index, int a, int amin, int amax)
{
...
void EditStudentProfileControl::addQualification(int ans, int min, int max)
{
 ...
 */
void EditStudentProfileControl::updateProfile()
{
...
void EditStudentProfileControl::editProfile()
{
    for(int i = 0; i < 28; i++) {
...
void EditStudentProfileControl::createProfile()
{
 ...
 */
void EditStudentProfileControl::loadProfileSettings(int id) {
...
void EditStudentProfileControl::exitProfile()
{
    _view.close();
}
