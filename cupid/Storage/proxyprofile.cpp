...
ProxyProfile::ProxyProfile() /*: _stuId(-1), _id(-1)*/{
}
 ...
 */
int ProxyProfile::addQualification(int answer, int min, int max){
    Qualification qual;
 ...
 *          and add it to db.
 */
int ProxyProfile::createProfile(){
/*
    QSqlQuery qry(Database::getInstance().db());
