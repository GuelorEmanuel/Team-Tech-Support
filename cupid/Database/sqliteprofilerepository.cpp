...
int SqliteProfileRepository::getProfile(ProfilePtr profile)
{
    ...
    if(profile->getId() == -1) {
        QString qprof =
            "SELECT id, "
            "id, q1, q1min, q1max, q2, q2min, q2max, q3, q3min, q3max, "
            "q4, q4min, q4max, q5, q5min, q5max, q6, q6min, q6max, q7, q7min, "
            "q7max, q8, q8min, q8max, q9, q9min, q9max, q10, q10min, q10max, "
            "q11, q11min, q11max, q12, q12min, q13max, q13, q13min, q13max, "
            "q14, q14min, q14max, q15, q15min, q15max, q16, q16min, q16max, "
            "q17, q17min, q17max, q18, q18min, q18max, q19, q19min, q19max, "
            "q20, q20min, q20max, q21, q21min, q21max, q22, q22min, q22max, "
            "q23, q23min, q23max, q24, q24min, q24max, q25, q25min, q25max, "
        ...
        qry.prepare(qprof);
        qry.bindValue(":id", profile->getUserId());
    } else {
        QString qprof =
            "SELECT id, "
            "user_id, q1, q1min, q1max, q2, q2min, q2max, q3, q3min, q3max, "
            "q4, q4min, q4max, q5, q5min, q5max, q6, q6min, q6max, q7, q7min, "
            "q7max, q8, q8min, q8max, q9, q9min, q9max, q10, q10min, q10max, "
            "q11, q11min, q11max, q12, q12min, q13max, q13, q13min, q13max, "
            "q14, q14min, q14max, q15, q15min, q15max, q16, q16min, q16max, "
    ...
    if(!qry.exec()) {
        ...
        qry.first();
        if(profile->getId() == -1)
            profile->setId(qry.value(0).toInt());
         else
            profile->setUserId(qry.value(1).toInt());
        for(int i = 2; i < 2+28*3; i+=3) {
            profile->addQualification(qry.value(i).toInt(), qry.value(i+1).toInt(), qry.value(i+2).toInt());
        }
        stat = 0;
    }
    return stat;
